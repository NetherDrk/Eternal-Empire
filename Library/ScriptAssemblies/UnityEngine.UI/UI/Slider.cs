...
namespace UnityEngine.UI
{
  ...
  public class Slider : Selectable, IEventSystemHandler, IInitializePotentialDragHandler, IDragHandler, ICanvasElement
  {
    ...
    /// 
    /// </summary>
    /// <param name="input">The new value for the slider.</param><param name="sendCallback">If the OnValueChanged callback should be invoked.</param>
