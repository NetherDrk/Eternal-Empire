...
namespace UnityEngine.UI
{
  ...
  public class VertexHelper : IDisposable
  {
    ...
    /// 
    /// </summary>
    /// <param name="vertex"/><param name="i"/>
    ...
    /// 
    /// </summary>
    /// <param name="position"/><param name="color"/><param name="uv0"/><param name="uv1"/><param name="normal"/><param name="tangent"/><param name="v"/>
    ...
    /// 
    /// </summary>
    /// <param name="idx0">Index 0.</param><param name="idx1">Index 1.</param><param name="idx2">Index 2.</param>
