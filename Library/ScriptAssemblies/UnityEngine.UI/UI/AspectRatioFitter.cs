...
namespace UnityEngine.UI
{
  ...
  public class AspectRatioFitter : UIBehaviour, ILayoutController, ILayoutSelfController
  {
      ...
      switch (this.m_AspectMode)
      {
        case AspectRatioFitter.AspectMode.None:
          if (Application.isPlaying)
            break;
          this.m_AspectRatio = Mathf.Clamp(this.rectTransform.rect.width / this.rectTransform.rect.height, 1.0 / 1000.0, 1000f);
          break;
    ...
    {
      this.m_AspectRatio = Mathf.Clamp(this.m_AspectRatio, 1.0 / 1000.0, 1000f);
      this.SetDirty();
    }
