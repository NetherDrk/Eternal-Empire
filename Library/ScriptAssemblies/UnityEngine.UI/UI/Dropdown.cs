...
namespace UnityEngine.UI
{
  ...
  public class Dropdown : Selectable, IEventSystemHandler, IPointerClickHandler, ISubmitHandler, ICancelHandler
  {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new Dropdown.\u003CDelayedDestroyDropdownList\u003Ec__Iterator2()
      {
        delay = delay,
        \u003C\u0024\u003Edelay = delay,
        \u003C\u003Ef__this = this
    ...
    public class OptionData
    {
      ...
      /// 
      /// </summary>
      /// <param name="text">Optional text for the option.</param><param name="image">Optional image for the option.</param>
      public OptionData()
      {
      }
