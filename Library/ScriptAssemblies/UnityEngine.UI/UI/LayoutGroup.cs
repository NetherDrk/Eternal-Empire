...
namespace UnityEngine.UI
{
  ...
  public abstract class LayoutGroup : UIBehaviour, ILayoutElement, ILayoutController, ILayoutGroup
  {
    ...
    public virtual void CalculateLayoutInputHorizontal()
    {
      ...
      {
        RectTransform rectTransform = this.rectTransform.GetChild(index1) as RectTransform;
        if (!((UnityEngine.Object) rectTransform == (UnityEngine.Object) null) && rectTransform.gameObject.activeInHierarchy)
        {
          ...
          else
          {
            ...
            {
              if (!((ILayoutIgnorer) list[index2]).ignoreLayout)
              {
                this.m_RectChildren.Add(rectTransform);
                break;
              }
    ...
    /// 
    /// </summary>
    /// <param name="axis">The axis index. 0 is horizontal and 1 is vertical.</param><param name="requiredSpaceWithoutPadding">The total space required on the given axis for all the layout elements including spacing and excluding padding.</param>
    /// <returns>
    /// 
    /// <para>
    ...
    /// 
    /// </summary>
    /// <param name="totalMin">The min size for the layout group.</param><param name="totalPreferred">The preferred size for the layout group.</param><param name="totalFlexible">The flexible size for the layout group.</param><param name="axis">The axis to set sizes for. 0 is horizontal and 1 is vertical.</param>
    ...
    /// 
    /// </summary>
    /// <param name="rect">The RectTransform of the child layout element.</param><param name="axis">The axis to set the position and size along. 0 is horizontal and 1 is vertical.</param><param name="pos">The position from the left side or top.</param><param name="size">The size.</param>
