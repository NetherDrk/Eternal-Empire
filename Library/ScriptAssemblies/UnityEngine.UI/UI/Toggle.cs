...
namespace UnityEngine.UI
{
  ...
  public class Toggle : Selectable, IEventSystemHandler, IPointerClickHandler, ISubmitHandler, ICanvasElement
  {
    ...
    {
      ToggleGroup toggleGroup = this.m_Group;
      ...
      if (!((UnityEngine.Object) newGroup != (UnityEngine.Object) null) || !((UnityEngine.Object) newGroup != (UnityEngine.Object) toggleGroup) || (!this.isOn || !this.IsActive()))
        return;
