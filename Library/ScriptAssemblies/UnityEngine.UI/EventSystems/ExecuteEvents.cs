...
namespace UnityEngine.EventSystems
{
  ...
  public static class ExecuteEvents
  {
    ...
    public static GameObject ExecuteHierarchy<T>(GameObject root, BaseEventData eventData, ExecuteEvents.EventFunction<T> callbackFunction) where T : IEventSystemHandler
    {
      ...
      {
        Transform transform = ExecuteEvents.s_InternalTransformList[index];
    ...
    private static void GetEventList<T>(GameObject go, IList<IEventSystemHandler> results) where T : IEventSystemHandler
    {
      ...
      {
        if (ExecuteEvents.ShouldSendToComponent<T>(list[index]))
          results.Add(list[index] as IEventSystemHandler);
      }
