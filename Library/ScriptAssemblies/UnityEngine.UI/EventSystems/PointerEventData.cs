...
namespace UnityEngine.EventSystems
{
  ...
  public class PointerEventData : BaseEventData
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.AppendLine("<b>eligibleForClick</b>: " + (object) (bool) (this.eligibleForClick ? 1 : 0));
      ...
      stringBuilder.AppendLine("<b>Use Drag Threshold</b>: " + (object) (bool) (this.useDragThreshold ? 1 : 0));
